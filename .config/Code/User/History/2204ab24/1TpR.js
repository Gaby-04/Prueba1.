...
const Seadra= new TipoAgua1("Seadra", "agua","Planta, Eléctrico");
const Snorlax = new TipoNormal1("Snorlax", "Normal","Lucha");
const Tangrowth = new TipoPlanta1("Tangrowth", "Planta","Fuego, Hielo, Veneno, Volador, Bicho");
